...
Original file is located at
    https://colab.research.google.com/drive/1u0V-ZbSJAtZw8QniqSrvQjYE1YweFP5B
"""
...
for epoch in range(20):
  ...
  out = compute_geometric_median(grads, weights=None)
  with torch.no_grad():
    sigma_out = compute_geometric_median(sigma_collected, weights=None)

  i=0
  for k in global_dict.keys():
      global_dict[k] = out.median[i]
      i=i+1
